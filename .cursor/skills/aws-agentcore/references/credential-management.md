...
- **[Identity Service](identity.md)**: Credential provider management
- **[Gateway Service](gateway.md)**: Uses credentials for API authentication
...
**Related Guides**:
- [Observability Service](observability.md)
